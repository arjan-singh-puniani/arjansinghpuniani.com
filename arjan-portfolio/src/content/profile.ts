export const profile = {
  ...
  biography: [
    ...
    "That distinction shapes his projects. ReasonOS records observations, evidence, contradictions, and revisions instead of preserving only an answer. SeizeFreeze develops focal cortical-cooling architecture from thermal models through control and packaging. His motorsport work connects crash mechanism, neurological findings, and medical handoff.",
    "Arjan earned a Master of Science in Bioengineering from the University of Pittsburgh after studying chemical engineering at the University of California, Berkeley. He now develops neural-engineering tools, research software, and medical-system concepts while preparing for medical training."
  ]
} as const;
