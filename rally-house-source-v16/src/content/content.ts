...
export const destinations:Record<string,Vec3>={
...
export const memberData=[
  {id:'coach',name:'Coach Contessa',role:'Head coach',shirt:'#75a985',skin:'#dca884',hair:'#4f3a31',accent:'#fff0d7',eye:'#506c61',hairStyle:'bun' as const,presentation:'feminine' as const,outfit:'skort' as const,shoe:'#fff8ed',playStyle:'calm technician',goal:'Help everyone leave with one useful cue',quirk:'Never rushes a correction',likes:['quiet mornings','clean footwork','sencha']},
  {id:'mika',name:'Lucresia',role:'Member',shirt:'#f0a078',skin:'#cf9270',hair:'#473029',accent:'#ffe0bc',eye:'#5b6658',hairStyle:'ponytail' as const,presentation:'feminine' as const,outfit:'skirt' as const,shoe:'#fffaf0',playStyle:'all-court learner',goal:'Prepare earlier on the forehand',quirk:'Counts clean rallies under her breath',likes:['crosscourt rhythm','matcha','sunny windows']},
  {id:'leo',name:'Leo',role:'Member',shirt:'#6faec0',skin:'#dfb38d',hair:'#40372f',accent:'#f4e9d8',eye:'#405d63',hairStyle:'crop' as const,presentation:'masculine' as const,outfit:'shorts' as const,shoe:'#f7fbf5',playStyle:'counterpuncher',goal:'Recover faster after wide balls',quirk:'Tests every grip in the pro shop',likes:['long rallies','fresh overgrips','bonsai']},
  {id:'nia',name:'Barbara',role:'Club host',shirt:'#d77f76',skin:'#a96d55',hair:'#2f2726',accent:'#ffd9d3',eye:'#4a5f50',hairStyle:'bob' as const,presentation:'feminine' as const,outfit:'host' as const,shoe:'#fff2e7',playStyle:'social doubles',goal:'Keep the morning calm without making it quiet',quirk:'Remembers everyone’s usual drink',likes:['people-watching','organization','oat matcha']}
];
...
export const conversationLines:Record<string,string[]>={
