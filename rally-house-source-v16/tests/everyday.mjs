...
test('v13 saves migrate unchanged and newly written envelopes use schema 8',()=>{assert.equal(CURRENT_SAVE_VERSION,8);const s={clock:{minutes:600,day:2,speed:1,paused:false},coins:17,mikaProgress:44,player:{x:0,z:0},relationships:{}};assert.equal(migrateGameSave(5,s).coins,17);assert.equal(new SaveSystem().version,8)});
